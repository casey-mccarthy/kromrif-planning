...
# kromrif_planning/
APPS_DIR = BASE_DIR / "kromrif_planning"
env = environ.Env()
...
ADMINS = [("""Developer""", "dev@example.com")]
...
ACCOUNT_FORMS = {"signup": "kromrif_planning.users.forms.UserSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Kromrif Planning API",
    "DESCRIPTION": "Documentation of API endpoints of Kromrif Planning",
    "VERSION": "1.0.0",
